  ...
  return (
    <div className="container resit-container h-100">
      <div className="resit-full-height resit-row">
        <div
          className="bg-info full-height col-7 resit-login-banner"
          style={banner_login_image}
        ></div>
        <div
          className="resit-full-height col-5 resitdc-login-form"
            ...
            <div className="form-signin">
              ...
              <div className="row">
                <div className="col-12">
                  <button
                    className="btn btn-info btn-block btn-lg mt-5 resit-radius-3"
                    type="submit"
                    onClick={handleLogin}
                  >
                    Masuk
                ...
                <div className="col-6">
                  <Link to="/home">
                    <button
                      className="btn btn-block btn-lg btn-outline-info resit-outline-size-2 mt-3 resit-radius-3"
                      type="button"
                    >
                      Home
                    </button>
